...
sudo wget -t 5 https://raw.githubusercontent.com/Manesh-R/cloudera-spectra-vip-new/master/cloudera-director.repo -O /etc/yum.repos.d/cloudera-director.repo >> ${LOG_FILE}
